...
function handleReceiveInterrupt() {
  this.writeControlRegister(exports.ControlRegister['BBREG1'], 0x04, function() {
    //TODO: measure if it is faster to just dump the entire FIFO, or read the length and then only the needed bytes.
    this.readFIFO(exports.FIFO['RX'], 0, exports.FIFO['RX'].size, function(data) {
      this.writeControlRegister(exports.ControlRegister['BBREG1'], 0x00, function() {      
