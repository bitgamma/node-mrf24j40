...
exports.MRF24J40.prototype.setPANID = function(panID) {
  this.writeControlRegister(exports.ControlRegister['PANIDH'], (panID & 0xFF));
  this.writeControlRegister(exports.ControlRegister['PANIDL'], (panID >> 8));
}

exports.MRF24J40.prototype.setShortAddress = function(shortAddress) {
  this.writeControlRegister(exports.ControlRegister['SADRH'], (shortAddress & 0xFF));
  this.writeControlRegister(exports.ControlRegister['SADRL'], (shortAddress >> 8));
}
...
function handleReceiveInterrupt() {
  ...
  var end = data.readUInt8(0); 
    
  var lqi = data.readUInt8(end);
  var rssi = data.readUInt8(end + 1);
  this.emit('frame', data.slice(0, end), lqi, rssi);
}
