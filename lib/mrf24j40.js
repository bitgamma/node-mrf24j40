...
exports.MRF24J40.prototype._transferControlRegister = function(controlRegister, value, write, cb) {
  ...
  hw.transfer(this.txBuf.slice(0, idx), this.rxBuf.slice(0, idx), cb);  
}
...
function encodeAddress(buf, address, longFormat, write) {
  var len = longFormat ? encodeLongAddress(buf, address, write) : encodeShortAddress(buf, address, write);
}
