...
exports.MRF24J40.prototype.setPANID = function(panID) {
  this.writeControlRegister(exports.ControlRegister['PANIDH'], panID[0]);
  this.writeControlRegister(exports.ControlRegister['PANIDL'], panID[1]);
}

exports.MRF24J40.prototype.setShortAddress = function(shortAddress) {
  this.writeControlRegister(exports.ControlRegister['SADRH'], shortAddress[0]);
  this.writeControlRegister(exports.ControlRegister['SADRL'], shortAddress[1]);
}
